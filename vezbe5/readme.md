...
Predstojeći zadatak nadograđuje _Pet Store_ veb-sajt sa prethodnih vežbi koristeći sledeće koncepte: **control flow** (_@if_, _@for_), **directives** (_ngClass_, _ngStyle_), **input** i **output**, kao i **content (view) projection**.
...
2. Umesto da dugme za smanjenje količine bude onemogućeno (_disabled_) kada je količina nula, koristiti **@if** da se dugme prikaže samo ukoliko je količina veća od nula.
